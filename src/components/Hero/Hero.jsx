...
const Hero = () => {
    ...
    const handleResumeClick = () => {
        window.open("https://drive.google.com/file/d/1FajNFJnIZVajJmoZtKj-R-sW2tlfKISI/view", "_blank");
    };
                        ...
                        <div ref={ref}>
                            {inView ? (
                                <Fade delay={5} duration={1000}>
                                    <h2 className="font-poppins font-bold text-2xl md:text-3xl lg:text-4xl">I am Jithesh Kota.</h2>
                                </Fade>
                            ) : (
